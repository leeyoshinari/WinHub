...
def getPublicHistUri(server_prefix, ver, file, file_id: str):
    return f'{server_prefix}/onlyoffice/downloadhistory/{file_id}?ver={ver}&file={file}'
            ...
            try:
                ...
                if isEnableDirectUrl:
                    ...
                    dataObj['directUrl'] = docManager.getDownloadUrl(filename) if i == version \
                        else getPublicHistUri(request_host, i, "prev" + fileUtils.getFileExt(filename), file_id)
                ...
                if i > 1:  # check if the version number is greater than 1 (the file was modified)
                    ...
                    obj['serverVersion'] = changes['serverVersion'] if change else None
